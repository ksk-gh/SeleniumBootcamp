...
public class AccountsStepdefinitions extends Base {
	...
	public void searchAccounts(String accountName) throws InterruptedException {
		WebElement searchAccounts = driver.findElement(By.xpath("//input[@name='Account-search-input']"));
		Thread.sleep(2000);
		searchAccounts.sendKeys(accountName);
