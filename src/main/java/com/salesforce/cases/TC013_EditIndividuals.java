...
public class TC013_EditIndividuals {
	@Test
	public static void tc013() throws InterruptedException {
	...
	executor.executeScript("arguments[0].click();", clickDropDown);
		...
		WebElement firstNameTextBox = driver.findElement(By.xpath("//label/span[text()='First Name']/following::input[1]"));
