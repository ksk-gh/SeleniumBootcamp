...
public void tc005(String accountName,String mobileNumber, String billStreet, String billCity, String billZipcode, String billState, String billCountry, String shipStreet, String shipCity, String shipZipcode, String shipState, String shipCountry
...
driver.findElement(By.xpath("//*[text()='Industry']/following::div[1]//button")).click();
	...
	WebElement billingStreet = driver.findElement(By.xpath("//*[text()='Billing Street']/following-sibling::div//textarea[@name='street']"));
	billingStreet.clear();
	billingStreet.sendKeys(billStreet);
	
	WebElement billingCity = driver.findElement(By.xpath("//*[text()='Billing City']/following-sibling::div/input"));
	billingCity.clear();
	billingCity.sendKeys(billCity);
	
	WebElement billingZipCode = driver.findElement(By.xpath("//*[contains(text(),'Billing Zip')]/following-sibling::div/input"));
	billingZipCode.clear();
	billingZipCode.sendKeys(billZipcode);
	
	WebElement billingState = driver.findElement(By.xpath("//*[contains(text(),'Billing State')]/following-sibling::div/input"));
	billingState.clear();
	billingState.sendKeys(billState);
	
	WebElement billingCountry=driver.findElement(By.xpath("//*[text()='Billing Country']/following-sibling::div/input"));
	billingCountry.clear();
	billingCountry.sendKeys(billCountry);
	
	
	WebElement shippingStreet=driver.findElement(By.xpath("//*[text()='Shipping Street']/following-sibling::div//textarea[@name='street'][1]"));
	shippingStreet.clear();
	shippingStreet.sendKeys(shipStreet);
	
	
	WebElement shippingCity=driver.findElement(By.xpath("//*[text()='Shipping City']/following-sibling::div/input"));
	shippingCity.clear();
	shippingCity.sendKeys(shipCity);
	
	WebElement shippingZipcode=driver.findElement(By.xpath("//*[contains(text(),'Shipping Zip')]/following-sibling::div/input"));
	shippingZipcode.clear();
	shippingZipcode.sendKeys(shipZipcode);
	
	WebElement shippingState = driver.findElement(By.xpath("//*[contains(text(),'Shipping State')]/following-sibling::div/input"));
	shippingState.clear();
	shippingState.sendKeys(shipState);
	
	WebElement shippingCountry =driver.findElement(By.xpath("//*[text()='Shipping Country']/following-sibling::div/input"));
